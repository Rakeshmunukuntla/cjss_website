...
export const LeadershipSection = () => {
  return (
    <section className="relative px-6 py-32 overflow-hidden bg-neutral-950">
      {/* Background Glow Effects */}
      <div className="absolute top-20 left-10 w-[260px] h-[260px] bg-purple-600/20 blur-[160px] -z-10" />
      <div className="absolute bottom-20 right-10 w-[260px] h-[260px] bg-cyan-500/20 blur-[160px] -z-10" />
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="space-y-28">
          {LEADERS.map((leader, idx) => (
            <div
              key={idx}
              className="group animate-fadeInUp transition-all duration-700 ease-out opacity-0 translate-y-6"
            >
              {idx % 2 === 0 ? (
                /* LEFT IMAGE / RIGHT TEXT */
                <div className="grid items-center gap-14 md:grid-cols-2">
                  ...
                  <div className="relative flex justify-center">
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-72 h-72 rounded-full bg-gradient-to-br from-purple-400 via-cyan-400 to-purple-500" />
                      </div>

                      {/* Glow */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-96 h-96 rounded-full bg-purple-500/25 blur-3xl" />
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pl-6 border-l-4 border-gradient-to-b from-purple-400 to-cyan-400">
                      <p className="text-lg leading-relaxed text-white/70">
                        {leader.bio}
                      </p>
                    </div>
                ...
                <div className="grid items-center gap-14 md:grid-cols-2">
                  ...
                  <div className="relative flex justify-center">
                    <div className="relative">
                      {/* Gradient Circle */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-72 h-72 rounded-full bg-gradient-to-br from-cyan-400 via-purple-400 to-cyan-500" />
                      </div>

                      {/* Glow */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-96 h-96 rounded-full bg-cyan-500/25 blur-3xl" />
                      </div>
