...
export default function BenefitsSection() {
  ...
  return (
    <section
      className="px-4 pt-12 pb-24 text-white md:px-6"
    ...
    >
      ...
      {/* Grid */}
      <div
        className="relative z-10 grid max-w-6xl grid-cols-1 gap-6 mx-auto sm:gap-8 sm:grid-cols-2 lg:grid-cols-3"
      >
        {benefits.map((b, index) => {
          const Icon = b.icon
          ...
          return (
            ...
            >
              ...
              {/* Card */}
              <div
                className="relative rounded-3xl bg-[#0b1625]/60 backdrop-blur-xl border border-white/10 p-6 md:p-8 h-full transition-all duration-500"
                onMouseMove={(e) => {
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed md:text-base text-white/70">{b.desc}</p>
              </div>
            </div>
          )
        })}
