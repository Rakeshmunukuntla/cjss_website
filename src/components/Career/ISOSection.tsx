...
//     const observer = new IntersectionObserver(
//       (entries) => {
//         if (entries[0].isIntersecting) ref.current?.classList.add('iso-visible')
//       },
//       { threshold: 0.3 },
//     )
//     if (ref.current) observer.observe(ref.current)
...
//   return (
//     <section className="relative px-4 pt-12 pb-24 overflow-hidden text-white sm:px-6 md:px-10">
//       {/* Floating lights (hidden on mobile for performance) */}
//       <div className="hidden md:block absolute -top-40 left-0 w-[400px] h-[400px] bg-cyan-500/15 blur-[200px] rounded-full"></div>
//       <div className="hidden md:block absolute bottom-0 right-0 w-[500px] h-[500px] bg-blue-700/20 blur-[220px] rounded-full"></div>
...
//           <div className="relative p-8 sm:p-10 md:p-12 rounded-full bg-neutral-900/60 border border-white/10 backdrop-blur-xl shadow-[0_0_40px_rgba(0,170,255,0.25)]">
...
//               <div
//                 key={i}
//                 className="relative p-6 overflow-hidden transition-all duration-300 border shadow-lg sm:p-7 md:p-8 group rounded-3xl border-white/10 bg-neutral-900/50 backdrop-blur-xl hover:-translate-y-2"
//               >
//                 {/* Hover Glow */}
//                 <div className="absolute inset-0 transition-all opacity-0 bg-gradient-to-br from-cyan-500/10 to-blue-600/10 group-hover:opacity-100 blur-xl"></div>
...
//                 <Icon className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 text-cyan-300 mb-4 drop-shadow-[0_0_10px_rgba(0,200,255,0.5)] magnetic-icon" />

//                 <h3 className="mb-2 text-lg font-semibold text-white sm:text-xl">{item.title}</h3>
