...
//             <div className="absolute top-20 left-[5%] w-80 h-80 bg-purple-500/10 rounded-full blur-[120px]" />
//             <div className="absolute bottom-20 right-[5%] w-96 h-96 bg-sky-500/8 rounded-full blur-[120px]" />
//           </div>

//           <div className="max-w-6xl px-4 mx-auto sm:px-6">
//             {/* Main Intro Card */}
//             <div className="relative mb-16 sm:mb-20">
//               <div className="relative rounded-[32px] border border-white/10 bg-gradient-to-b from-white/[0.04] to-transparent p-8 sm:p-12 md:p-16 overflow-hidden">
//                 {/* Corner accents - purple to sky gradient colors */}
//                 <div className="absolute top-0 left-0 w-32 h-32">
//                   <div className="absolute top-6 left-6 w-20 h-[1px] bg-gradient-to-r from-purple-400/60 to-transparent" />
//                   <div className="absolute top-6 left-6 w-[1px] h-20 bg-gradient-to-b from-purple-400/60 to-transparent" />
//                 </div>
//                 <div className="absolute top-0 right-0 w-32 h-32">
//                   <div className="absolute top-6 right-6 w-20 h-[1px] bg-gradient-to-l from-sky-400/60 to-transparent" />
//                   <div className="absolute top-6 right-6 w-[1px] h-20 bg-gradient-to-b from-sky-400/60 to-transparent" />
//                 </div>
//                 <div className="absolute bottom-0 left-0 w-32 h-32">
//                   <div className="absolute bottom-6 left-6 w-20 h-[1px] bg-gradient-to-r from-purple-400/60 to-transparent" />
//                   <div className="absolute bottom-6 left-6 w-[1px] h-20 bg-gradient-to-t from-purple-400/60 to-transparent" />
//                 </div>
//                 <div className="absolute bottom-0 right-0 w-32 h-32">
//                   <div className="absolute bottom-6 right-6 w-20 h-[1px] bg-gradient-to-l from-sky-400/60 to-transparent" />
//                   <div className="absolute bottom-6 right-6 w-[1px] h-20 bg-gradient-to-t from-sky-400/60 to-transparent" />
//                 </div>
...
//                     people who feel{" "}
//                     <span className="text-transparent bg-gradient-to-r from-purple-300 to-sky-300 bg-clip-text font-medium">
//                       empowered
//                     </span>
//                     ,{" "}
//                     <span className="text-transparent bg-gradient-to-r from-purple-300 to-sky-300 bg-clip-text font-medium">
...
//                       inspired
//                     </span>
//                     . Our culture is shaped by collaboration, continuous
//                     learning, and a shared commitment to delivering meaningful
...
//                 <div
//                   key={section.id}
//                   className="life-card-animate group"
//                   style={{ animationDelay: `${index * 0.1}s` }}
//                 >
//                   <div
//                     className="relative h-full p-6 sm:p-8 rounded-[24px] border transition-all duration-500 overflow-hidden
//                     border-white/10 hover:border-purple-400/40
//                     bg-[#0a0a0a]/80 backdrop-blur-sm hover:bg-[#0a0a0a]/95
//                     hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(168,85,247,0.12)]"
//                   >
//                     {/* Hover glow - gradient effect */}
//                     <div className="absolute top-0 right-0 w-40 h-40 rounded-full blur-3xl transition-opacity duration-500 opacity-0 group-hover:opacity-20 bg-gradient-to-br from-purple-500 to-sky-500" />
...
//                         <div className="mt-1.5 w-2 h-2 rounded-full shrink-0 bg-gradient-to-r from-purple-400 to-sky-400" />
//                         <h3 className="text-lg sm:text-xl font-semibold text-transparent bg-gradient-to-r from-purple-300 to-sky-300 bg-clip-text">
//                           {section.title}
//                         </h3>
//                       </div>

//                       {/* Description */}
//                       <p className="text-sm sm:text-base leading-relaxed text-white/60 group-hover:text-white/75 transition-colors duration-300">
//                         {section.description}
//                       </p>
//                     </div>
//                   </div>
...
//             <p className="text-[10px] sm:text-xs font-semibold tracking-[0.25em] text-transparent bg-gradient-to-r from-purple-300 to-sky-300 bg-clip-text uppercase animate-fadeInUp">
//               Inside pods
//             </p>
...
//         .life-card-animate {
//           animation: lifeCardUp 0.7s ease-out both;
//         }
