    ...
    <section className="min-h-screen bg-neutral-950 text-white px-4 sm:px-6 py-20 sm:py-28">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="p-5 sm:p-8 text-center">
                ...
                <button
                  ...
                  className="rounded-full border border-white/40 px-5 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-white backdrop-blur transition-all hover:bg-white/10 hover:border-white/70 hover:scale-105"
                >
                  Know More →
                </button>
              </div>
        ...
        {/* <div className="mt-16 sm:mt-24 text-center">
          <div className="inline-block px-8 py-10 rounded-3xl border border-white/10 bg-gradient-to-r from-purple-500/5 via-transparent to-sky-500/5">
            <h3 className="text-xl sm:text-2xl font-semibold text-white mb-3">
              Need a Custom Solution?
            </h3>
            <p className="text-white/60 text-sm sm:text-base mb-6 max-w-2xl mx-auto">
              We build tailored platforms that fit your unique business needs.
              Let's discuss how we can help transform your operations.
            </p>
            <button
              onClick={() => {
                // Navigate to contact or about page
                window.location.href = "mailto:contact@cjss.com";
              }}
              className="px-6 py-3 bg-gradient-to-r from-purple-600 to-sky-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-sky-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-purple-500/50"
            >
              Get in Touch
            </button>
          </div>
