...
const JobOpeningsBase = ({
  ...
  useEffect(() => {
    if (selectedJob || applyJob || showSuccess) {
  ...
  }, [selectedJob, applyJob, showSuccess]);
    ...
    <>
      ...
      <AnimatePresence>
        {selectedJob && (
          ...
          >
            {/* 
              ✅ top padding = navbar height (e.g. pt-24 = 96px)
              ✅ bottom padding so it never hides behind footer
              ✅ no scrollbar on the card itself — the backdrop scrolls
            */}
            <motion.div
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-3xl font-extrabold pr-12">
                <GradientHeading>{selectedJob.title}</GradientHeading>
              </h3>

              <p className="mt-3 inline-block px-3 py-1 text-xs rounded-full bg-white/10 border border-white/20 text-white">
                {selectedJob.category}
              </p>
        ...
        {applyJob && (
          ...
          >
            ...
            >
              ...
              {/* Title */}
              <h3 className="mb-6 text-2xl font-bold pr-12">
                <span className="text-white">Apply for </span>
                <GradientHeading>{applyJob.title}</GradientHeading>
              </h3>
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${
                          submitting
                            ? "bg-white/20 cursor-not-allowed text-white/50 border border-white/20"
                            : "border border-white/40 hover:border-white/70 hover:bg-white/10 text-white"
                        }
                      `}
                    >
                      {submitting ? (
      ...
      <AnimatePresence>
        {showSuccess && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center z-[99999]"
