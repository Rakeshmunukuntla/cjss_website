...
export const DigitalPlatformsPage = () => {
  const service = TECHNOLOGY_SERVICES.find((s) => s.id === "digital-platforms")!
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 bg-neutral-900 border border-neutral-800 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6 shadow-lg shadow-purple-500/10">
          <div className="flex-1">
            ...
            <p className="text-white/80">Ready to launch your digital commerce platform? Reach out and we'll connect you with our platform experts.</p>
          </div>
          <div className="w-full md:w-80 bg-neutral-950 border border-neutral-800 rounded-xl p-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-purple-500/20 flex items-center justify-center text-2xl font-bold text-purple-400">RG</div>
              <div>
                <div className="font-semibold text-white">Rajiv Gupta</div>
                <div className="text-sm text-white/70">Digital Commerce Lead</div>
              </div>
            </div>

            <div className="mt-4 text-sm">
              <div className="text-white/80">Email: <a className="text-purple-300 hover:text-cyan-300 underline" href="mailto:commerce@cjss.example">commerce@cjss.example</a></div>
