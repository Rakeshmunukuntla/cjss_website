...
export const AIServicesPage = () => {
  const service = TECHNOLOGY_SERVICES.find((s) => s.id === "ai-services")!
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 bg-neutral-900 border border-neutral-800 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6 shadow-sm">
          <div className="flex-1">
            ...
            <p className="text-white">Ready to harness AI for your business? Reach out and we'll connect you with our AI/ML experts.</p>
          </div>
          <div className="w-full md:w-80 bg-neutral-900 border border-neutral-800 rounded-xl p-4 shadow-sm">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-purple-500/20 flex items-center justify-center text-2xl font-bold text-purple-400">NK</div>
              <div>
                <div className="font-semibold text-white">Neha Kapoor</div>
                <div className="text-sm text-white">AI/ML Solutions Lead</div>
              </div>
            </div>

            <div className="mt-4 text-sm">
              <div className="text-white">Email: <a className="text-purple-400 hover:text-purple-300 underline" href="mailto:ai@cjss.example">ai@cjss.example</a></div>
