    ...
    <main className="relative w-full min-h-screen text-white">
      ...
      <div className="fixed inset-0 z-0" style={{ opacity: heroOpacity }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-10 md:px-20 flex flex-col justify-center h-full">
          ...
          <p className="mt-4 max-w-3xl text-sm sm:text-base text-slate-200/90 animate-fade-up [animation-delay:0.12s]">
            Our Quality Engineering & Assurance services are designed to ensure
            that applications and digital platforms remain reliable, scalable,
      ...
      <div className="relative z-10">
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            ...
            <p className="mt-5 max-w-4xl text-base sm:text-lg text-slate-300 animate-fade-up [animation-delay:0.1s]">
              Our Quality Engineering & Assurance services are designed to
              ensure that applications and digital platforms remain reliable,
              scalable, and ready for continuous change. We take a
              lifecycle-driven, shift-left approach to quality by embedding
              assurance practices early and continuously across delivery
              pipelines. By combining automation, AI-assisted quality insights,
              and continuous validation, we help organizations reduce release
              risk, accelerate delivery, and maintain consistent quality as
              systems evolve.
            </p>
            ...
            <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              ...
              <div className="animate-fade-up">
                ...
                <h3 className="text-xl font-semibold">
                  Quality Engineering Strategy & Enablement
                </h3>
                <p className="mt-3 text-slate-300">
                  We help organizations define a quality engineering strategy
                  that aligns with business objectives, delivery velocity, and
                  platform complexity.
                </p>
                <a
              ...
              <div className="animate-fade-up [animation-delay:0.05s]">
                ...
                <p className="mt-3 text-slate-300">
                  We enable automation-driven quality practices across
                  functional, regression, and integration workflows.
                </p>
                <a
                  href="#section-automation"
                  className="mt-3 inline-block text-purple-300 hover:text-sky-300 transition-colors"
                >
                  Read More →
                </a>
              ...
              <div className="animate-fade-up [animation-delay:0.1s]">
                ...
                <p className="mt-3 text-slate-300">
                  We validate end-to-end business workflows across
                  interconnected systems to ensure data consistency, process
                  reliability, and seamless user journeys.
                </p>
                <a
                  href="#section-e2e"
                  className="mt-3 inline-block text-purple-300 hover:text-sky-300 transition-colors"
              ...
              <div className="animate-fade-up [animation-delay:0.15s]">
                ...
                <h3 className="text-xl font-semibold">
                  Performance, Load & Scalability Assurance
                </h3>
                <p className="mt-3 text-slate-300">
                  We help organizations assess how systems behave under
                  real-world load, concurrency, and stress conditions.
                </p>
                <a
              ...
              <div className="animate-fade-up [animation-delay:0.2s]">
                ...
                <h3 className="text-xl font-semibold">
                  Security-Focused Quality & Risk Assurance
                </h3>
                <p className="mt-3 text-slate-300">
                  We embed security and risk validation into quality workflows
                  by identifying vulnerabilities, configuration risks, and
                  compliance gaps early in the delivery lifecycle.
                </p>
                <a
              ...
              <div className="animate-fade-up [animation-delay:0.25s]">
                ...
                <h3 className="text-xl font-semibold">
                  Continuous Quality Monitoring & Optimization
                </h3>
                <p className="mt-3 text-slate-300">
                  We enable continuous quality monitoring by analyzing test
                  results, system behavior, and production signals.
                </p>
                <a
        ...
        {/* =====================================================
            SECTION 1 — QUALITY ENGINEERING STRATEGY & ENABLEMENT
        ===================================================== */}
        <section
          id="section-strategy"
          className="w-full py-20 sm:py-24 bg-gradient-to-b from-[#050816] to-[#0b1120]"
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We help organizations define a quality engineering strategy that
              aligns with business objectives, delivery velocity, and platform
              complexity. Our approach focuses on integrating quality practices
              into planning, development, and delivery workflows rather than
              treating testing as a standalone phase.
            </p>

            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <img
                src="\images\QA\QA1.png"
                alt="Quality Engineering Strategy"
                className="w-full rounded-xl shadow-xl animate-slide-left"
              />
              <div className="animate-slide-right">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Clear quality strategy aligned with business goals</li>
                  <li>• Early identification of quality risks</li>
                  <li>• Reduced late-stage defects</li>
                  <li>• Predictable and controlled release cycles</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {/* =====================================================
            SECTION 2 — TEST AUTOMATION & CONTINUOUS VALIDATION
        ===================================================== */}
        <section
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light animate-fade-up">
              <span className="font-semibold">Test Automation</span> &
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We enable automation-driven quality practices across functional,
              regression, and integration workflows. Our focus is on building
              scalable, maintainable automation that supports frequent releases
              and adapts as applications and platforms evolve.
            </p>
            ...
            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <div className="animate-slide-left">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Faster and more reliable release cycles</li>
                  <li>• Reduced manual testing effort</li>
                  <li>• Early defect detection and prevention</li>
                  <li>• Consistent quality across environments</li>
                </ul>
              </div>
              <img
                src="\images\QA\QA2.png"
                alt="Test Automation"
                className="w-full rounded-xl shadow-xl animate-slide-right"
              />
            </div>
        ...
        {/* =====================================================
            SECTION 3 — END-TO-END WORKFLOW & INTEGRATION TESTING
        ===================================================== */}
        <section
          id="section-e2e"
          className="w-full py-20 sm:py-24 bg-gradient-to-b from-[#050816] to-[#0b1120]"
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light animate-fade-up">
              <span className="font-semibold">End-to-End Workflow</span> &
              Integration Testing
            </h2>
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We validate end-to-end business workflows across interconnected
              systems to ensure data consistency, process reliability, and
              seamless user journeys. Our approach focuses on verifying
              real-world scenarios rather than isolated components.
            </p>

            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <img
                src="\images\QA\QA3.png"
                alt="E2E Testing"
                className="w-full rounded-xl shadow-xl animate-slide-left"
              />
              <div className="animate-slide-right">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Reliable end-to-end business processes</li>
                  <li>• Early detection of integration issues</li>
                  <li>• Improved data accuracy and consistency</li>
                  <li>• Reduced downstream operational defects</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {/* =====================================================
            SECTION 4 — PERFORMANCE, LOAD & SCALABILITY ASSURANCE
        ===================================================== */}
        <section
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light animate-fade-up">
              <span className="font-semibold">Performance, Load</span> &
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We help organizations assess how systems behave under real-world
              load, concurrency, and stress conditions. Our quality engineering
              approach ensures applications can scale reliably without
            ...
            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <div className="animate-slide-left">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Improved system performance and responsiveness</li>
                  <li>• Confidence during high-traffic and peak events</li>
                  <li>• Early identification of scalability bottlenecks</li>
                  <li>• Reduced performance-related incidents</li>
                </ul>
              </div>
              <img
                src="\images\QA\QA4.png"
                alt="Performance Assurance"
                className="w-full rounded-xl shadow-xl animate-slide-right"
              />
            </div>
          </div>
        ...
        {/* =====================================================
            SECTION 5 — SECURITY-FOCUSED QUALITY & RISK ASSURANCE
        ===================================================== */}
        <section
          id="section-security"
          className="w-full py-20 sm:py-24 bg-gradient-to-b from-[#050816] to-[#0b1120]"
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light animate-fade-up">
              <span className="font-semibold">Security-Focused Quality</span> &
              Risk Assurance
            </h2>
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We embed security and risk validation into quality workflows by
              identifying vulnerabilities, configuration risks, and compliance
              gaps early in the delivery lifecycle. Our approach ensures quality
              and security evolve together.
            </p>

            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <img
                src="\images\QA\QA5.png"
                alt="Security Quality Assurance"
                className="w-full rounded-xl shadow-xl animate-slide-left"
              />
              <div className="animate-slide-right">
                <h3 className="text-xl sm:text-2xl font-semibold">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Reduced exposure to quality and security risks</li>
                  <li>• Improved compliance readiness</li>
                  <li>• Early risk mitigation across releases</li>
                  <li>• Safer and more resilient systems</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {/* =====================================================
            SECTION 6 — CONTINUOUS QUALITY MONITORING & OPTIMIZATION
        ===================================================== */}
        <section
        ...
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20">
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-5xl animate-fade-up [animation-delay:0.08s]">
              We enable continuous quality monitoring by analyzing test results,
              system behavior, and production signals. AI-assisted insights help
              identify recurring quality issues, patterns, and improvement
              opportunities across releases.
            </p>
            ...
            <div className="mt-16 sm:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <div className="animate-slide-left">
                ...
                <ul className="mt-4 text-base sm:text-lg text-slate-300 space-y-3">
                  <li>• Continuous visibility into quality health</li>
                  <li>• Faster feedback loops for teams</li>
                  <li>• Improved release confidence</li>
                  <li>• Ongoing quality improvement over time</li>
                </ul>
              </div>
              <img
